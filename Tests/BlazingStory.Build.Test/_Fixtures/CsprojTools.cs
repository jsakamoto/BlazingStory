...
{
    /// <summary>
    /// Rewrite the project file to change the target framework and the path to the BlazingStory.targets file.
    /// </summary>
    internal static void Rewrite(string projDir, string targetFramework, string blazingStoryTargetsPath)
    {
        ...
        // Replace the target framework specification in the project content with the pattern such as "<TaregtFramework>net???</TargetFramework>" by Regular Expression.
