...
internal class StoryTest
{
    ...
    {
        var story = new Story(Descriptor("Pages/Authentication and Authorization"), typeof(object), "Sign In", new BlazingStory.Types.StoryContext([]), null, null, EmptyFragment, null);
