...
internal class TestFixtureSpace : IDisposable
{
    ...
    /// <summary>
    /// The working directory that contains the fixture test project files. <br /> The working
    /// directory is created by copying the fixture directory into under the output folder of the
    /// test project.
    /// </summary>
    internal WorkDirectory WorkDir { get; }

    /// <summary>
    /// The full path of the BlazingStory project directory.
    /// </summary>
    internal string BlazingStoryProjDir { get; }

    /// <summary>
    /// The full path of the /Build/BlazingStory.targets file.
    /// </summary>
