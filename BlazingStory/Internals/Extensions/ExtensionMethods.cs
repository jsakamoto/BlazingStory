...
internal static class ExtensionMethods
{
    ...
    /// <summary>
    /// Returns a new dictionary that contains all the elements of the original dictionary except
    /// the ones with the specified keys.
    /// </summary>
    /// <param name="value">
    /// A dictionary to exclude the specified keys.
    /// </param>
    /// <param name="keysToExclude">
    /// Key strings to exclude from the dictionary.
    /// </param>
    /// <returns>
    /// A dictionary that contains all the elements of the original dictionary except the ones with
    /// the specified keys.
    /// </returns>
    ...
    /// A type object to compare with the specified generics type.
    /// </param>
    /// <param name="genericsType">
    /// A generics type to compare with the specified type.
    /// </param>
    /// <returns>
    /// Returns true if the specified type is the specified generics type. otherwise, false.
    /// </returns>
